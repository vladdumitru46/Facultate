...
namespace networking
{
    ...
    public class ConcurrentServerProtobuf : AbstractServer
    {
        private readonly IService _server;

        public ConcurrentServerProtobuf(string host, int port, IService server) : base(host, port)
        {
            _server = server;
        }
        ...
        {
            var clientObjectWorker = new ProtobufWorker(_server, client);
